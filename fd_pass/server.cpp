...
int main()
{
    ...
    if((nufd = accept(ufd, (struct sockaddr*)&cli_addr, (socklen_t*)&len)) < 0)
    {
        perror("accept");
        exit(1);
    }
    ...
    if((nsfd1=accept(sfd1,(struct sockaddr*)&inet_cliaddr1,(socklen_t*)&len))<0)
    {
    ...
    if((nsfd2=accept(sfd2,(struct sockaddr*)&inet_cliaddr2,(socklen_t*)&len))<0)
    {
