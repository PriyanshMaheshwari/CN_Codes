...
#define SNAME1 "SEMA1"
sem_unlink(SNAME1);
sem_t *sem1 = sem_open(SNAME1, O_CREAT, 0644, 0);
if (sem1 == SEM_FAILED) {
	perror("sem 1 open failed");
	exit(EXIT_FAILURE);
}
sem_wait(sem1);
sem_post(sem1);
